...
const Navbar = () => {
  ...
  return (
    <>
      <nav className='w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 bg-lawrencium1 shadow-2xl shadow-lawrencium1'>
        <a href="">
          <Image alt='' src={assets.e_letter} className='w-22 cursor-pointer mr-14'/>
        </a>

        <ul className='hidden md:flex items-center gap-6 lg:gap-14 px-8 py-4 bg-lawrencium1 font-share-tech-mono text-xl'>
        ...
        <div className='flex items-center gap-6'>
          ...
          <a href="#github" className='hidden lg:flex items-center gap-4 px-8 py-2.5  bg-lawrencium1 text-white ml-4 text-xl font-share-tech-mono'> 
        ...
        <ul ref={sideMenu} className='flex md:hidden flex-col gap-2 py-20 px-1 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-lawrencium3 transition duration-500 font-share-tech-mono text-xl'>
          ...
          <li className=' px-3' onClick={closeMenu}><a href="#contact" className='text-white'>My projects</a></li>
        </ul>
